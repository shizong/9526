...
public class Config {
	...
	public  static  final  String  SERVER_URL="http://192.168.1.110:8080/TestServer/api.jsp";
	public  static  final  String APP_ID="com.example.s500";
	...
	public  static void  cachePhoneNum(Context  context,String token){

		Editor  e=context.getSharedPreferences(APP_ID, Context.MODE_PRIVATE).edit();
		e.putString(KEY_PHONE_NUM, token);
		e.commit();
	}
